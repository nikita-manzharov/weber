...
<html lang="ru">
	...
	<body>
		<div class="container justify-content-center p=0 m=0" id="Form">
			<?php
				if (!empty($messages)) {
          ...
          print($mess);
			...
			<form method="POST" action="">
				...
				<input type="text" id="inName" name="inName" <?php if ($errors['inName']) {print 'class="error"';} ?> value="<?php print $values['inName']; ?>" placeholder="Имя"><br>
