...
if ($_SERVER['REQUEST_METHOD'] == 'GET') {
  ...
  $errors['checke'] = !empty($_COOKIE['checke_error']);
...
// Иначе, если запрос был методом POST, т.е. нужно проверить данные и сохранить их в XML-файл.
  ...
  if (empty($_POST['checke'])) {
    // Выдаем куку на день с флажком об ошибке в поле name.
    setcookie('checke_error', '1', time() + 24 * 60 * 60);
    $errors = TRUE;
  }
...
// *************
  ...
  if ($errors) {
    ...
    $db_user = "u17368"; // Логин БД
    $db_password = "4415325"; // Пароль БД
    $db_table = "appl3"; // Имя Таблицы БД
    ...
    try {
        ...
        $db = new PDO('mysql:host=localhost;dbname=u17368', $db_user, $db_password, array(PDO::ATTR_PERSISTENT => true));
